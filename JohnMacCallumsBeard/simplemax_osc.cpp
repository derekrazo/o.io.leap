...
//  simplemax
//
//  Created by Derek Razo on 4/19/13.
//
//
...
int main(void)
{
	...
	c = class_new("simplemax", (method)akaleapmotion_new, (method)akaleapmotion_free, (long)sizeof(t_akaleapmotion),
...
void akaleapmotion_bang(t_akaleapmotion *x)
{
    ...
    osc_message_u_setAddress(msg, "Leap: ");
	...
	for(size_t i = 0; i < numHands; i++)
	{
		...
		for(size_t j = 0; j < numFingers; j++)
		{
            ...
            osc_atom_u_setInt32(a, finger_id);
